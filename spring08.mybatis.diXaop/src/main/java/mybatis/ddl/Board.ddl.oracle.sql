...
Insert into TB_BBS_ATTACHFILE (FILENAME,FILETYPE,FILESIZE,ARTICLENO,USEYN,INSERTUID,INSERTDT,UPDATEUID,UPDATEDT) values ('����ġ����','����Ÿ��',10,1,1,'attachfile','2016/12/09','filetype','2016/12/09');
Insert into TB_BBS_ATTACHFILE (FILENAME,FILETYPE,FILESIZE,ARTICLENO,USEYN,INSERTUID,INSERTDT,UPDATEUID,UPDATEDT) values ('����ġ����','����Ÿ��',10,1,1,'attachfile','2016/12/09','filetype','2016/12/09');
Insert into TB_BBS_ATTACHFILE (FILENAME,FILETYPE,FILESIZE,ARTICLENO,USEYN,INSERTUID,INSERTDT,UPDATEUID,UPDATEDT) values ('����ġ����','����Ÿ��',10,1,1,'attachfile','2016/12/09','filetype','2016/12/09');
Insert into TB_BBS_ATTACHFILE (FILENAME,FILETYPE,FILESIZE,ARTICLENO,USEYN,INSERTUID,INSERTDT,UPDATEUID,UPDATEDT) values ('����ġ����','����Ÿ��',10,1,1,'attachfile','2016/12/09','filetype','2016/12/09');
Insert into TB_BBS_ATTACHFILE (FILENAME,FILETYPE,FILESIZE,ARTICLENO,USEYN,INSERTUID,INSERTDT,UPDATEUID,UPDATEDT) values ('����ġ����','����Ÿ��',10,1,1,'attachfile','2016/12/09','filetype','2016/12/09');
